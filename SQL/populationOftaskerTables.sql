...
INSERT INTO `test`.`projectsuggestions` (`Title`, `ShortDescription`, `DetailedDescription`, `CreatedBy`, `DateCreated`, `InvestmentRequired`, `EstimatedReturn`, `Priority`, `Notes`, `ImageURL`) VALUES ('Online Herbs Shopping', 'This project helps the users in curing its disease by giving the list of fruits and herbs that the user should consume in order to get rid of its disease.', 'http://nevonprojects.com/online-herbs-shopping/', '15', '16-03-03', '5000', '7500', '1', '-', '-');
INSERT INTO `test`.`projectsuggestions` (`Title`, `ShortDescription`, `DetailedDescription`, `CreatedBy`, `DateCreated`, `InvestmentRequired`, `EstimatedReturn`, `Priority`, `Notes`, `ImageURL`) VALUES ('Hotel Management Android Project', 'The regular hotel management system project entirely in an android app. This android application allows the hotel manager to handle all hotel activities in his android phone.', 'http://nevonprojects.com/hotel-management-android/', '21', '16-03-01', '8000', '1000', '1','-', '-');
INSERT INTO `test`.`projectsuggestions` (`Title`, `ShortDescription`, `DetailedDescription`, `CreatedBy`, `DateCreated`, `InvestmentRequired`, `EstimatedReturn`, `Priority`, `Notes`, `ImageURL`) VALUES ('Efficient Doctor Patient Portal', 'We here propose a doctor patient handling, managing system that helps doctors in their work and also patients to book doctor appointments and view medical progress. The system allows doctors to manage their booking slots online.', 'http://nevonprojects.com/efficient-doctor-patient-portal/', '22', '16-03-16', '10000', '13000', '1', '-', '-');
INSERT INTO `test`.`projectsuggestions` (`Title`, `ShortDescription`, `DetailedDescription`, `CreatedBy`, `DateCreated`, `InvestmentRequired`, `EstimatedReturn`, `Priority`, `Notes`, `ImageURL`) VALUES ('Android Local Train Ticketing Project', 'A local train ticketing system project for local trains that allows users to book local train tickets and get ticket receipt online. This local train project provides login rights for normal users and admin. ', 'http://nevonprojects.com/android-local-train-ticketing-project/', '23', '16-03-17', '11000', '14000', '1', '-', '-');

-- Insert Tasks
INSERT INTO `test`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Make Inserts Work', 'Make Inserts Work', '...', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `test`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title1', 'Make the login user interface and the connection to the database.', '...', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
...
INSERT INTO `test`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title4', 'Login', 'User will login to the system using his fingerprint.', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
