...
INSERT INTO `database`.`projects` (`Title`, `ShortDescription`, `DetailedDescription`, `CreatedBy`, `ProjectLead`, `DateCreated`, `ModificationLogLink`, `Notes`, `AvailableFunds`, `CurrentYield`, `DateTerminated`, `TerminationReason`, `TerminatedBy`, `CollectedFunds`, `ConsumedFunds`, `ImageURL`) VALUES ('DataMinr', 'Real Estate Search Based On Data Mining', 'This project helps the users to make good decisions regarding buying or selling of valuable property. Prior to this online system this process involved a lot of travelling costs and searching time.', '20', '20', '2015-08-08', 'http://nevonprojects.com/real-estate-search-based-on-data-mining/', 'Fun...', '-', '-', '1970/01/01', '-', '0', '-', '-', '-');

-- Insert ProjectSuggestions
INSERT INTO `database`.`projectsuggestions` (`Title`, `ShortDescription`, `DetailedDescription`, `CreatedBy`, `DateCreated`, `InvestmentRequired`, `EstimatedReturn`, `Priority`, `Notes`, `ImageURL`) VALUES ('Online Herbs Shopping', 'This project helps the users in curing its disease by giving the list of fruits and herbs that the user should consume in order to get rid of its disease.', 'http://nevonprojects.com/online-herbs-shopping/', '15', '16-03-03', '5000', '7500', '1', '-', '-');
INSERT INTO `database`.`projectsuggestions` (`Title`, `ShortDescription`, `DetailedDescription`, `CreatedBy`, `DateCreated`, `InvestmentRequired`, `EstimatedReturn`, `Priority`, `Notes`, `ImageURL`) VALUES ('Hotel Management Android Project', 'The regular hotel management system project entirely in an android app. This android application allows the hotel manager to handle all hotel activities in his android phone.', 'http://nevonprojects.com/hotel-management-android/', '21', '16-03-01', '8000', '1000', '1','-', '-');
INSERT INTO `database`.`projectsuggestions` (`Title`, `ShortDescription`, `DetailedDescription`, `CreatedBy`, `DateCreated`, `InvestmentRequired`, `EstimatedReturn`, `Priority`, `Notes`, `ImageURL`) VALUES ('Efficient Doctor Patient Portal', 'We here propose a doctor patient handling, managing system that helps doctors in their work and also patients to book doctor appointments and view medical progress. The system allows doctors to manage their booking slots online.', 'http://nevonprojects.com/efficient-doctor-patient-portal/', '22', '16-03-16', '10000', '13000', '1', '-', '-');
INSERT INTO `database`.`projectsuggestions` (`Title`, `ShortDescription`, `DetailedDescription`, `CreatedBy`, `DateCreated`, `InvestmentRequired`, `EstimatedReturn`, `Priority`, `Notes`, `ImageURL`) VALUES ('Android Local Train Ticketing Project', 'A local train ticketing system project for local trains that allows users to book local train tickets and get ticket receipt online. This local train project provides login rights for normal users and admin. ', 'http://nevonprojects.com/android-local-train-ticketing-project/', '23', '16-03-17', '11000', '14000', '1', '-', '-');

-- Insert Tasks
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Make Inserts Work', 'Make Inserts Work', '...', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title1', 'Make the login user interface and the connection to the database.', '...', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title2', 'Track the user’s location', 'Track the user’s location with the help of GPS and send this detail to admin.', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title3', 'Make and graphical interface in order to view the location of the driver driving the vehicle.', 'Make and graphical interface in order to view the location of the driver driving the vehicle','1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title4', 'Login', 'User will login to the system using his fingerprint.', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title5', 'Add Pin Code', ' User has to scan finger and add pin code in order to do transactions.', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title6', 'Withdrawal of cash', 'User can withdraw cash by entering the amount he want to withdraw.', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title7', 'Transfer of Money', 'User can transfer cash to other accounts by entering the account number he wants to transfer.', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title8', 'Login', 'Make the login user interface and the connection to the database.', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title9', 'Track the user’s location', 'Track the user’s location with the help of GPS and send this detail to admin.', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title10', 'View the location of the employee', 'Make and graphical interface in order to view the location of the employee.', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title11', 'Create database', ' Create a database of sentiment based keywords along with positivity or negativity weight in database', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title12', 'Rank user comment', 'Based on the sentiment keywords from the database the user comment needs to be ranked. ', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title13', 'Rate the product', 'Rate the product based on the data recieved from the users comments.', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title14', 'Create employee database and add new employees', 'Create the database with the specific tablles and fields. Add new employees by filling employee details and will provide identity number and password to the employee to access the system.', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title15', 'Login', 'Make the login user interface and the connection to the database.When employee login to the system he will get email about the meetings that is going to be held on next day with the lead.', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title16', 'Dashboard', 'User will be redirected to dashboard where he will get to know about number of leads he had converted and number of leads he had not converted.User will also get to know about profit and loss amount in the dashboard, based on number of leads he had converted.',  '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title17', 'Meetings options', 'Employee can fix meeting with customer by specifying the meeting topic and description about the meeting. User can view meeting that is going to be held. User can also view the topic and description about the meeting. User can send SMS and E-mail to the customers.', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title18', 'Create the estate database', 'Property details like Address, space measurement(sq ft), number of BHKs, Floor, Property Seller name and its contact number plus email-id. ', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title19', 'Search option', 'The user can search property depending on the area that it wants in, number of wash rooms, bedrooms, halls and kitchen.', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
INSERT INTO `database`.`tasks` (`ParentId`, `Title`, `ShortDescription`, `DetailedDescription`, `ParentProject`, `DateCreated`, `CreatedBy`, `DateCompleted`, `CompletedBy`, `DeadLine`, `Status`, `Notes`, `ImageURL`) VALUES ('0', 'Title20', 'Loan algorithm', 'An algorithm that calculates loan that the user can take plus 20%-30% cash that the user has to pay.', '1', '2016/04/22', '1', '2016/04/22', '1', '2016/04/24', 'Completed', '-', '-');
