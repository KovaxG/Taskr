/*
	...
	Notes: Defapt aceste comenzi nu au nevoie de numele
	bazei de date, deci o denumesti cum vrei si totul o sa mearga.
...
INSERT INTO `secretary` (`FirstName`,`LastName`,`DisplayName`,`AvatarLink`,`Email`,`PasswordHash`,`PhoneNumber`,`JoinDate`,`Status`,`PersonalNotes`,`LeaveDate`,`ReasonForLeaving`,`RejoinDesirability`,`Observations`) VALUES ('Zelea','Anamaria','Anamaria','http://www.telekyoto.web.auth.gr/images/Avatar_woman.gif','zelea.anamaria@gmail.com','¼ 6ðÙ¾`Îø¡','0758885423','2012-05-20','Not Available','-','2016-05-07','Found another job','Low','Good employee');
INSERT INTO `secretary` (`FirstName`,`LastName`,`DisplayName`,`AvatarLink`,`Email`,`PasswordHash`,`PhoneNumber`,`JoinDate`,`Status`,`PersonalNotes`,`LeaveDate`,`ReasonForLeaving`,`RejoinDesirability`,`Observations`) VALUES ('Tusca','Florin','Florin','http://www.finearttips.com/wp-content/uploads/2010/05/avatar.jpg','tusca.florin@gmail.com','Ä\Zpfç¾Z0¦Æç~','0723665478','2011-05-04','Available','Fire Popescu Andrei.','1970-01-01','-','-','-');
...
INSERT INTO `users` (`FirstName`,`LastName`,`DisplayName`,`AvatarLink`,`Email`,`PasswordHash`,`PhoneNumber`,`JoinDate`,`AddedBy`,`ActiveProject`,`ActiveTask`,`WorkStatus`,`PersonalNotes`,`LeaveDate`,`ReasonForLeaving`,`RejoinDesirability`,`Observations`) VALUES ('Badea','Nicolae','Nicu','http://www.finearttips.com/wp-content/uploads/2010/05/avatar.jpg','badea.nicolae@gmail.com',':jD@0ìÊÚÔ °','0741258745','2012-07-14',5,1,0,'Not Available','-','2016-04-08','Medical problems','Medium','Went abroad to get treatment for his illness.');
INSERT INTO `users` (`FirstName`,`LastName`,`DisplayName`,`AvatarLink`,`Email`,`PasswordHash`,`PhoneNumber`,`JoinDate`,`AddedBy`,`ActiveProject`,`ActiveTask`,`WorkStatus`,`PersonalNotes`,`LeaveDate`,`ReasonForLeaving`,`RejoinDesirability`,`Observations`) VALUES ('Baltag ','Octavian','Tavi','http://www.finearttips.com/wp-content/uploads/2010/05/avatar.jpg','baltag.octavian@gmail.com','TøxàgD*8P8p','0741857457','2012-03-13',4,2,0,'Available','-','1970-01-01','-','-','-');
...
INSERT INTO `users` (`FirstName`,`LastName`,`DisplayName`,`AvatarLink`,`Email`,`PasswordHash`,`PhoneNumber`,`JoinDate`,`AddedBy`,`ActiveProject`,`ActiveTask`,`WorkStatus`,`PersonalNotes`,`LeaveDate`,`ReasonForLeaving`,`RejoinDesirability`,`Observations`) VALUES ('Enache','Sorin','Soso','http://www.finearttips.com/wp-content/uploads/2010/05/avatar.jpg','enache.sorin@gmail.com','þLåüÀæÄl4`','0721473698','2015-03-16',2,3,0,'Working','-','1970-01-01','-','-','-');
INSERT INTO `users` (`FirstName`,`LastName`,`DisplayName`,`AvatarLink`,`Email`,`PasswordHash`,`PhoneNumber`,`JoinDate`,`AddedBy`,`ActiveProject`,`ActiveTask`,`WorkStatus`,`PersonalNotes`,`LeaveDate`,`ReasonForLeaving`,`RejoinDesirability`,`Observations`) VALUES ('Gheorghe ','Daniel','Dani','http://www.finearttips.com/wp-content/uploads/2010/05/avatar.jpg','gheorghe.daniel@gmail.com','ìî4X< ü0¸s','0723698741','2015-07-13',3,3,9,'Holiday','-','1970-01-01','-','-','-');
INSERT INTO `users` (`FirstName`,`LastName`,`DisplayName`,`AvatarLink`,`Email`,`PasswordHash`,`PhoneNumber`,`JoinDate`,`AddedBy`,`ActiveProject`,`ActiveTask`,`WorkStatus`,`PersonalNotes`,`LeaveDate`,`ReasonForLeaving`,`RejoinDesirability`,`Observations`) VALUES ('Jurca','Avram','Avram','http://www.finearttips.com/wp-content/uploads/2010/05/avatar.jpg','jurca.traian@gmail.com','ÔØÐä¦ ¼ÄØPôÖ','0752142365','2014-09-15',4,2,6,'Available','-','1970-01-01','-','-','-');
INSERT INTO `users` (`FirstName`,`LastName`,`DisplayName`,`AvatarLink`,`Email`,`PasswordHash`,`PhoneNumber`,`JoinDate`,`AddedBy`,`ActiveProject`,`ActiveTask`,`WorkStatus`,`PersonalNotes`,`LeaveDate`,`ReasonForLeaving`,`RejoinDesirability`,`Observations`) VALUES ('Lascu','Dan','Dan','http://www.finearttips.com/wp-content/uploads/2010/05/avatar.jpg','lascu.dan@gmail.com','Ø2ðþÚÀÆøPNøªàö','0721212585','2013-04-13',2,1,2,'Working','-','1970-01-01','-','-','-');
...
INSERT INTO `users` (`FirstName`,`LastName`,`DisplayName`,`AvatarLink`,`Email`,`PasswordHash`,`PhoneNumber`,`JoinDate`,`AddedBy`,`ActiveProject`,`ActiveTask`,`WorkStatus`,`PersonalNotes`,`LeaveDate`,`ReasonForLeaving`,`RejoinDesirability`,`Observations`) VALUES ('Popescu','Andrei','Andrei','http://www.finearttips.com/wp-content/uploads/2010/05/avatar.jpg','popescu.andrei@gmail.com','¨ ´T ôb`$ À','0752551435','2016-04-01',2,5,17,'Available','-','1970-01-01','-','-','-');
...
-- Insert Projects
INSERT INTO `projects` (`Title`,`ShortDescription`,`DetailedDescription`,`CreatedBy`,`ProjectLead`,`DateCreated`,`ModificationLogLink`,`Notes`,`AvailableFunds`,`CurrentYield`,`DateTerminated`,`TerminationReason`,`TerminatedBy`,`CollectedFunds`,`ConsumedFunds`,`ImageURL`) VALUES ('Vehicle Tracking','Vehicle Tracking Using Driver Mobile Gps Tracking','This system will track location of the vehicle and will send details about the location to the admin. This system helps admin to find out the location of the driver driving the vehicle. Admin will know which driver is in which location. ',2,2,'2013-05-20','http://nevonprojects.com/vehicle-tracking-using-driver-mobile-gps-tracking/','-','20000','2.3%','1970-01-01','-',0,'-','-','http://www.solutionsunlimited.co.ke/wp-content/uploads/2016/04/vehicle-tracking1.jpg');
INSERT INTO `projects` (`Title`,`ShortDescription`,`DetailedDescription`,`CreatedBy`,`ProjectLead`,`DateCreated`,`ModificationLogLink`,`Notes`,`AvailableFunds`,`CurrentYield`,`DateTerminated`,`TerminationReason`,`TerminatedBy`,`CollectedFunds`,`ConsumedFunds`,`ImageURL`) VALUES ('Smart ATM','Fingerprint Based ATM System','Fingerprint Based ATM is a desktop application where fingerprint of the user is used as a authentication. The finger print minutiae features are different for each human being so the user can be identified uniquely.',4,4,'2012-08-20','http://nevonprojects.com/fingerprint-based-atm-system/','-','30000','2.4%','1970-01-01','-',0,'-','-','https://i.ytimg.com/vi/QN6bbLiA6Io/maxresdefault.jpg');
INSERT INTO `projects` (`Title`,`ShortDescription`,`DetailedDescription`,`CreatedBy`,`ProjectLead`,`DateCreated`,`ModificationLogLink`,`Notes`,`AvailableFunds`,`CurrentYield`,`DateTerminated`,`TerminationReason`,`TerminatedBy`,`CollectedFunds`,`ConsumedFunds`,`ImageURL`) VALUES ('Employee Tracker','Android Employee Tracker','This system is a combination of web as well as android application where the user will be using the android application and admin as well as HR will work with web application. This application is meant for field work Employers.',19,19,'2012-03-20','http://nevonprojects.com/android-employee-tracker/','-','18000','2.1%','1970-01-01','-',0,'-','-','http://www.phonesheriff.com/images/lndg/employee-mobile-tracking.png');
INSERT INTO `projects` (`Title`,`ShortDescription`,`DetailedDescription`,`CreatedBy`,`ProjectLead`,`DateCreated`,`ModificationLogLink`,`Notes`,`AvailableFunds`,`CurrentYield`,`DateTerminated`,`TerminationReason`,`TerminatedBy`,`CollectedFunds`,`ConsumedFunds`,`ImageURL`) VALUES ('Product Rating','Sentiment Analysis for Product Rating','Here we propose an advanced Sentiment Analysis for Product Rating system that detects hidden sentiments in comments and rates the product accordingly. The system uses sentiment analysis methodology in order to achieve desired functionality.',17,17,'2014-04-15','http://nevonprojects.com/sentiment-analysis-for-product-rating/','If more funds are received, project can be finished.','12000','1.9%','2016-05-01','Not enough funds',17,'0','12000','http://www.smashstack.com/articles/wp-content/uploads/2015/07/star-rating-676x507.jpg');
INSERT INTO `projects` (`Title`,`ShortDescription`,`DetailedDescription`,`CreatedBy`,`ProjectLead`,`DateCreated`,`ModificationLogLink`,`Notes`,`AvailableFunds`,`CurrentYield`,`DateTerminated`,`TerminationReason`,`TerminatedBy`,`CollectedFunds`,`ConsumedFunds`,`ImageURL`) VALUES ('Customer Relationship Management','Android Customer Relationship Management System','Customer relationship management (CRM) is a system for managing a company’s interactions with current and future customers. It often involves using technology to organize, automate, and synchronize sales.',12,12,'2014-07-13','http://nevonprojects.com/android-customer-relationship-management-system/','-','18000','3%','1970-01-01','-',0,'-','-','http://infoglobaltech.com/wp-content/uploads/2013/08/shutterstock_CRM.jpg');
INSERT INTO `projects` (`Title`,`ShortDescription`,`DetailedDescription`,`CreatedBy`,`ProjectLead`,`DateCreated`,`ModificationLogLink`,`Notes`,`AvailableFunds`,`CurrentYield`,`DateTerminated`,`TerminationReason`,`TerminatedBy`,`CollectedFunds`,`ConsumedFunds`,`ImageURL`) VALUES ('Find Real Estate','Real Estate Search Based On Data Mining','This project helps the users to make good decisions regarding buying or selling of valuable property. Prior to this online system this process involved a lot of travelling costs and searching time.',20,20,'2015-08-08','http://nevonprojects.com/real-estate-search-based-on-data-mining/','-','22000','2.2%','2016-03-03','Finished Project',20,'44000','21000','http://propertyuk.com/wp-content/uploads/2013/06/Find-A-Property-UK.jpg');

-- Insert ProjectSuggestions
INSERT INTO `projectsuggestions` (`Title`,`ShortDescription`,`DetailedDescription`,`CreatedBy`,`DateCreated`,`InvestmentRequired`,`EstimatedReturn`,`Priority`,`Notes`,`ImageURL`) VALUES ('Online Herbs Shopping','This project helps the users in curing its disease by giving the list of fruits and herbs that the user should consume in order to get rid of its disease.','http://nevonprojects.com/online-herbs-shopping/',15,'2016-03-03','5000','7500','1','-','http://blog.deewal.com/wp-content/uploads/2015/09/Deewal-1.jpg');
INSERT INTO `projectsuggestions` (`Title`,`ShortDescription`,`DetailedDescription`,`CreatedBy`,`DateCreated`,`InvestmentRequired`,`EstimatedReturn`,`Priority`,`Notes`,`ImageURL`) VALUES ('Hotel Management Android Project','The regular hotel management system project entirely in an android app. This android application allows the hotel manager to handle all hotel activities in his android phone.','http://nevonprojects.com/hotel-management-android/',21,'2016-03-01','8000','1000','1','-','https://0.s3.envato.com/files/85489040/CC_FEATURED_IMAGE_590x300.png');
INSERT INTO `projectsuggestions` (`Title`,`ShortDescription`,`DetailedDescription`,`CreatedBy`,`DateCreated`,`InvestmentRequired`,`EstimatedReturn`,`Priority`,`Notes`,`ImageURL`) VALUES ('Efficient Doctor Patient Portal','We here propose a doctor patient handling, managing system that helps doctors in their work and also patients to book doctor appointments and view medical progress. The system allows doctors to manage their booking slots online.','http://nevonprojects.com/efficient-doctor-patient-portal/',22,'2016-03-16','10000','13000','1','-','http://cc-carecloudsitefinal.s3-website-us-east-1.amazonaws.com/wp-content/uploads/2014/07/secure-patient-portal1.png');
INSERT INTO `projectsuggestions` (`Title`,`ShortDescription`,`DetailedDescription`,`CreatedBy`,`DateCreated`,`InvestmentRequired`,`EstimatedReturn`,`Priority`,`Notes`,`ImageURL`) VALUES ('Android Local Train Ticketing Project','A local train ticketing system project for local trains that allows users to book local train tickets and get ticket receipt online. This local train project provides login rights for normal users and admin. ','http://nevonprojects.com/android-local-train-ticketing-project/',23,'2016-03-17','11000','14000','1','-','https://tctechcrunch2011.files.wordpress.com/2014/03/1-welcome.png?w=400');

-- Insert Tasks
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Login','Make the login user interface and the connection to the database','-',1,'2015-05-02',2,'2015-06-03',11,'2015-06-08','Completed','-','http://www.itdapaderucoffee.com/images/login_img.gif');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Track the user’s location','Track the user’s location with the help of GPS and send this detail to admin.','-',1,'2015-07-03',2,'1970-01-01',0,'2016-07-03','Worked on','-','3.bp.blogspot.com/-v0uyr9Nw1cw/VRpjC1EGd_I/AAAAAAAAA84/CdC3369R8cI/s1600/Graphic1.png');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'View the location of the driver','Make and graphical interface in order to view the location of the driver driving the vehicle','-',1,'2016-02-01',2,'1970-01-01',0,'2016-09-01','Available','-','3.bp.blogspot.com/-v0uyr9Nw1cw/VRpjC1EGd_I/AAAAAAAAA84/CdC3369R8cI/s1600/Graphic1.png');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Login','User will login to the system using his fingerprint.','-',2,'2016-01-21',4,'1970-01-01',0,'2016-08-21','Worked on','-','http://www.itdapaderucoffee.com/images/login_img.gif');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Add Pin Code','User has to scan finger and add pin code in order to do transactions','-',2,'2016-01-22',4,'1970-01-01',0,'2016-07-01','Available','-','http://static1.businessinsider.com/image/51fa59096bb3f7ff1100000a/study-finds-that-a-shocking-number-of-people-still-use-stupidly-easy-pin-codes-like-1234.jpg');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Withdrawal of cash','User can withdraw cash by entering the amount he want to withdraw.','-',2,'2016-01-23',4,'1970-01-01',0,'2016-06-01','Worked on','-','http://www.pesapoint.co.ke/images/cash_withdrawal.jpg');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Transfer of Money','User can transfer cash to other accounts by entering the account number he wants to transfer.','-',2,'2016-01-23',4,'2016-01-29',5,'2016-02-01','Completed','-','http://www.checksmartstores.com/wp-content/uploads/2012/12/Money-Transfer_33807311.jpg');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Login','Make the login user interface and the connection to the database.','-',3,'2016-03-20',19,'2016-03-25',7,'2016-04-20','Completed','-','http://www.itdapaderucoffee.com/images/login_img.gif');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Track the user’s location','Track the user’s location with the help of GPS and send this detail to admin.','-',3,'2016-03-20',19,'1970-01-01',0,'2016-06-20','Worked on','-','3.bp.blogspot.com/-v0uyr9Nw1cw/VRpjC1EGd_I/AAAAAAAAA84/CdC3369R8cI/s1600/Graphic1.png');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'View the location of the employee','Make and graphical interface in order to view the location of the employee.','-',3,'2016-03-20',19,'1970-01-01',0,'2016-06-20','Available','-','3.bp.blogspot.com/-v0uyr9Nw1cw/VRpjC1EGd_I/AAAAAAAAA84/CdC3369R8cI/s1600/Graphic1.png');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Rank user comment','Based on the sentiment keywords from the database the user comment needs to be ranked.','-',4,'2016-01-15',17,'1970-01-01',0,'2016-08-15','Available','-','http://blog.performics.com/wp-content/uploads/2013/04/Comments.jpg');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Create database','Create a database of sentiment based keywords along with positivity or negativity weight in database','-',4,'2015-08-15',17,'2016-04-15',17,'2016-04-15','Completed','-','http://www.altran.ch/uploads/tx_templavoila/Database-System_03.jpg');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Rate the product','Rate the product based on the data recieved from the users comments.','-',4,'2016-01-15',17,'1970-01-01',0,'2016-08-15','Available','-','http://www.shoemoney.com/wp-content/uploads/2014/05/rate_products.jpg');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Employee database','Create employee database and add new employees','Create the database with the specific tablles and fields. Add new employees by filling employee details and will provide identity number and password to the employee to access the system.',5,'2015-08-13',12,'2015-09-13',12,'2015-09-13','Completed','-','http://www.altran.ch/uploads/tx_templavoila/Database-System_03.jpg');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Login','Login actions + interface + database handler','Make the login user interface and the connection to the database.When employee login to the system he will get email about the meetings that is going to be held on next day with the lead',5,'2015-09-13',12,'2015-10-13',13,'2015-10-18','Completed','-','http://www.itdapaderucoffee.com/images/login_img.gif');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Create the estate database','Create the database with all the tables required and populate tabled with accurate fields.','Property details like Address, space measurement(sq ft), number of BHKs, Floor, Property Seller name and its contact number plus email-id',6,'2015-08-10',20,'2015-09-08',15,'2015-09-20','Completed','-','http://www.altran.ch/uploads/tx_templavoila/Database-System_03.jpg');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Dashboard','The user actions: he can see number of leads, profit and loss amount','User will be redirected to dashboard where he will get to know about number of leads he had converted and number of leads he had not converted.User will also get to know about profit and loss amount in the dashboard, based on number of leads he had converted',5,'2016-02-13',12,'1970-01-01',0,'2016-05-13','Worked on','-','http://www.ppc-essentials.com/wp-content/uploads/2014/03/Analytics-Dashboard.jpg');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Meetings options','The user actions: view meetings, meeting topics, send/ receive SMS,Email','Employee can fix meeting with customer by specifying the meeting topic and description about the meeting. User can view meeting that is going to be held. User can also view the topic and description about the meeting. User can send SMS and E-mail to the customers.',5,'2016-03-13',12,'1970-01-01',0,'2016-06-13','Available','-','http://b.fastcompany.net/multisite_files/fastcompany/imagecache/1280/poster/2016/02/3057102-poster-p-1-encryption-app-telegram-hits-100-million-users.jpg');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Search option','What can the user do, create a search function.','The user can search property depending on the area that it wants in, number of wash rooms, bedrooms, halls and kitchen.',6,'2015-09-08',20,'2015-11-10',13,'2015-11-11','Completed','-','http://www.yolink.com/yolink/wordpress/images/BlueOrbSearch.png');
INSERT INTO `tasks` (`ParentId`,`Title`,`ShortDescription`,`DetailedDescription`,`ParentProject`,`DateCreated`,`CreatedBy`,`DateCompleted`,`CompletedBy`,`DeadLine`,`Status`,`Notes`,`ImageURL`) VALUES (0,'Loan algorithm','An algorithm that calculates loan that the user can take plus 20%-30% cash that the user has to pay.','-',6,'2016-02-10',20,'2016-02-10',20,'2016-02-10','Completed','-','http://4.bp.blogspot.com/-Tz4tZ_e9IwU/VilExwxSLzI/AAAAAAAADck/RuBHdfbLmx8/s1600/algorithms-and-algorithmic-notations.png');

-- taskrequests
INSERT INTO `taskrequests` (`user_id`,`task_id`) VALUES (13,18);
INSERT INTO `taskrequests` (`user_id`,`task_id`) VALUES (7,10);
INSERT INTO `taskrequests` (`user_id`,`task_id`) VALUES (15,10);
INSERT INTO `taskrequests` (`user_id`,`task_id`) VALUES (22,10);
INSERT INTO `taskrequests` (`user_id`,`task_id`) VALUES (14,5);
INSERT INTO `taskrequests` (`user_id`,`task_id`) VALUES (3,3);
INSERT INTO `taskrequests` (`user_id`,`task_id`) VALUES (11,3);
INSERT INTO `taskrequests` (`user_id`,`task_id`) VALUES (18,3);

-- projectrequests
INSERT INTO `projectrequests` (`user_id`,`project_id`) VALUES (23,1);
INSERT INTO `projectrequests` (`user_id`,`project_id`) VALUES (20,2);
INSERT INTO `projectrequests` (`user_id`,`project_id`) VALUES (17,3);
INSERT INTO `projectrequests` (`user_id`,`project_id`) VALUES (1,5);
INSERT INTO `projectrequests` (`user_id`,`project_id`) VALUES (23,2);
INSERT INTO `projectrequests` (`user_id`,`project_id`) VALUES (17,1);
--